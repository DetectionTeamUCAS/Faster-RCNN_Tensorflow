...
# ------------------------------------------------
VERSION = 'FasterRCNN_Res50_20180603COCO'
...
DECAY_STEP = [350000, 490000]  # 50000, 70000
MAX_ITERATION = 500000

# -------------------------------------------- Data_preprocess_config
DATASET_NAME = 'coco'  #'pascal'  # 'ship', 'spacenet', 'pascal', 'coco'
...
ANCHOR_SCALES = [0.25, 0.5, 1., 2.0]  # [4, 8, 16, 32]
ANCHOR_RATIOS = [0.5, 1., 2.0]
ROI_SCALE_FACTORS = [10., 10., 5.0, 5.0]
ANCHOR_SCALE_FACTORS = None  # [10.0, 10.0, 5.0, 5.0]
